...
const faqs = [
  {
    ...
    answer: 'Necesitas ser mayor de 18 años, tener un ingreso comprobable, identificación oficial vigente y comprobante de domicilio. El proceso es 100% digital y no requiere aval.',
  },
  {
    question: '¿Cuánto tiempo tarda la aprobación?',
    answer: 'La mayoría de las solicitudes son aprobadas en menos de 10 minutos. En casos excepcionales, el proceso puede tomar hasta 24 horas.',
  },
  {
    question: '¿Cuál es el monto máximo que puedo solicitar?',
    answer: 'Puedes solicitar desde $1,000 hasta $50,000 pesos mexicanos, dependiendo de tu perfil crediticio y capacidad de pago.',
  },
  {
    question: '¿Qué tasa de interés manejan?',
    answer: 'Nuestras tasas van del 12% al 24% anual, dependiendo del perfil del cliente. Siempre mostramos la tasa exacta antes de que firmes el contrato.',
  },
  {
    question: '¿Puedo pagar anticipadamente sin penalización?',
    answer: 'Sí, puedes pagar anticipadamente sin ningún costo adicional. Incluso puedes ahorrar en intereses al hacerlo.',
  },
  {
    question: '¿Cómo funciona el proceso de desembolso?',
    answer: 'Una vez aprobado tu préstamo, el dinero se transfiere directamente a tu cuenta bancaria en menos de 24 horas hábiles.',
  },
  {
    question: '¿Qué pasa si no puedo pagar a tiempo?',
    answer: 'Te contactamos para encontrar una solución. Ofrecemos opciones de reestructuración y planes de pago flexibles para ayudarte.',
  },
  {
    question: '¿Mis datos están seguros?',
    answer: 'Absolutamente. Utilizamos encriptación bancaria de nivel militar y cumplimos con todas las regulaciones de protección de datos financieros.',
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-hero-subtitle text-[hsl(var(--color-zaga-silver))] max-w-2xl mx-auto">
            Resolvemos las dudas más comunes sobre nuestros préstamos personales.
          </p>
        </div>
          ...
          <Card className="bg-gradient-to-r from-[hsl(var(--color-zaga-gray-50))] to-white border-[hsl(var(--color-zaga-green-gray))]/20">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-body text-[hsl(var(--color-zaga-silver))] mb-8 max-w-2xl mx-auto">
                Nuestro equipo de atención al cliente está disponible 24/7 para resolver cualquier pregunta que tengas.
              </p>
