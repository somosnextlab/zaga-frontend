        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[hsl(var(--color-zaga-green-gray))] text-white font-bold">
                Z
              </div>
              <span className="text-xl font-bold">Zaga</span>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-body-sm text-gray-400">
              © 2024 Zaga. Todos los derechos reservados.
            </div>
