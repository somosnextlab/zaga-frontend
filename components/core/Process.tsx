...
const steps = [
  {
    ...
    description: 'Llena el formulario en línea con tus datos personales y financieros. Es rápido y seguro.',
  },
  {
    number: '02',
    icon: CheckCircle2,
    title: 'Recibe aprobación',
    description: 'Nuestro sistema evalúa tu solicitud y te notifica la decisión en minutos.',
  },
  {
    number: '03',
    icon: Wallet,
...
export const Process: React.FC = () => {
    ...
    try {
      if (user) {
        ...
        if (role === 'admin') {
          ...
          alert('Los administradores no pueden solicitar préstamos. Esta función está disponible solo para clientes.');
          return;
  ...
  return (
    <section id="como-funciona" className="bg-gradient-to-br from-[hsl(var(--color-zaga-gray-50))] to-white py-16 md:py-24">
          ...
          <Card className="bg-gradient-to-r from-[hsl(var(--color-zaga-green-gray))] to-[hsl(var(--color-zaga-green-hover))] border-0 text-white">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg mb-6 opacity-90">
                Únete a miles de clientes que ya confían en Zaga para sus necesidades financieras.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-[hsl(var(--color-zaga-green-gray))]"
                  asChild
                >
                  <Link href="#faq">
