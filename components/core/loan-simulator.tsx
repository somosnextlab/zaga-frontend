  ...
  const handleContinuar = async () => {
    ...
    try {
      if (user) {
        ...
        router.push(`${ROUTES.REGISTER || '/auth/register'}?${params.toString()}`);
      }
    } catch (error) {
      ...
      <CardContent className="p-8 space-y-8">
        ...
        <div className="bg-gradient-to-r from-[hsl(var(--color-zaga-green-gray))]/10 to-[hsl(var(--color-zaga-green-gray))]/5 rounded-lg p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-center">
            <div>
              <p className="text-caption text-[hsl(var(--color-zaga-silver))]">Tasa anual</p>
              <p className="text-body font-semibold text-[hsl(var(--color-zaga-black))]">
                {tasaAnual * 100}%
              </p>
            </div>
            <div>
              <p className="text-caption text-[hsl(var(--color-zaga-silver))]">Total a pagar</p>
              <p className="text-body font-semibold text-[hsl(var(--color-zaga-black))]">
